...
namespace PersistCriteria.Blazor.Server {
    public partial class PersistCriteriaBlazorApplication : BlazorApplication {
        public PersistCriteriaBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void PersistCriteriaBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
